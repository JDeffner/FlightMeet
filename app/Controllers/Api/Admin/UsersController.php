...
class UsersController extends BaseController
{
    private const SORTABLE = [
        ...
        'email', 'active', 'subscription_tier', 'last_active', 'created_at',
    ];
    ...
    public function index(): ResponseInterface
    {
        ...
        $rows = $this->buildFilteredQuery($search, $group, $active)
            ->select(
                ...
                . 'u.subscription_tier, u.last_active, u.created_at, i.secret AS email, '
    ...
    public function create(): ResponseInterface
    {
        ...
        $validation->setRules(UserModel::createRules());
        ...
        $user = new User([
            ...
            'plz'      => $data['plz'] ?? null,
            'ort'      => $data['ort'] ?? null,
            'subscription_tier' => $data['subscription_tier'] ?? 'pilot',
            'active'   => 1,
        ]);
    ...
    public function update(int $id): ResponseInterface
    {
        ...
        $validation = service('validation');
        $validation->setRules(UserModel::updateRules($id));
